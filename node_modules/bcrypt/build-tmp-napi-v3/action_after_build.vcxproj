...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{76FF05B5-6FDE-DE8B-8A92-69195AAB5BC4}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      ...
      <Command>call mkdir &quot;D:\xampp\htdocs\node-express-project\node_modules\bcrypt\lib\binding\napi-v3&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;D:\xampp\htdocs\node-express-project\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to D:\xampp\htdocs\node-express-project\node_modules\bcrypt\lib\binding\napi-v3</Message>
      <Outputs>D:\xampp\htdocs\node-express-project\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{0713D30F-05D4-2C4F-3F95-742520B9F1D8}</Project>
